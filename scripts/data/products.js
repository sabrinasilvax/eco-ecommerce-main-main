const products = [
   {
    ...
    },
    {
      ...
      title: "Kit 5 Camisas",
      price: 15.99,
      description: "A camisa social é uma peça-chave quando falamos em vestimentas mais formais, principalmente no ambiente profissional. Isso porque ela consegue combinar sofisticação com praticidade em uma única peça, dando um ar de elegância e profissionalismo para quem a veste. 5 opções de pura sofisticação.",
      category: "men's clothing",
    ...
    },
    {
      ...
      title: "Pantalona Verde",
      price: 695,
      description: "A Calça Pantalona é uma peça versátil e confortável para compor seus looks, oferecendo o equilíbrio perfeito entre estilo e praticidade.A proposta da calça pantalona permite que mulheres de todos os estilos criem diversas possibilidades com a peça.",
      category: "jewelery",
      image: "../../../imgs/pantalona-verde.png",
    ...
    },
    {
      ...
      title: "Camisa Social",
      price: 9.99,
      description: "A camisa social é uma peça-chave quando falamos em vestimentas mais formais, principalmente no ambiente profissional. Isso porque ela consegue combinar sofisticação com praticidade em uma única peça, dando um ar de elegância e profissionalismo para quem a veste.",
      category: "jewelery",
      image: "../../../imgs/camisa-social.png",
